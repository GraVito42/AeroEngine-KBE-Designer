...
INPUT_SCHEMA = {
    ...
    "engine_geometry": {
        ...
        "spool_tip_length":      {"label": "Spool tip length",              "unit": "m", "type": "float", "default": 0.2,   "min": 0.0,   "max": 1.0},
        "spool_length":          {"label": "Spool length",                  "unit": "m", "type": "float", "default": 1.5,   "min": 0.3,   "max": 6.0},
